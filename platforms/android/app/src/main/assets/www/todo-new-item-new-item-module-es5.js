...
var NewItemPage = /** @class */ (function () {
    function NewItemPage(router, formBuilder, itemService) {
        this.router = router;
    ...
    NewItemPage.prototype.goBack = function () {
        this.router.navigate(['/todo']);
    };
    NewItemPage.prototype.createItem = function (value) {
...
//# sourceMappingURL=todo-new-item-new-item-module-es5.js.map