...
var map = {
	"./menu/home.module": [
		...
		"default~calendrier-home-module~menu-home-module",
		"menu-home-module"
	],
	"./todo/home/home.module": [
		"./src/app/todo/home/home.module.ts",
		"common",
		"todo-home-home-module"
	],
	"./todo/new-item/new-item.module": [
		"./src/app/todo/new-item/new-item.module.ts",
		"common",
		"todo-new-item-new-item-module"
	],
	"./todo/update-item/update-item.module": [
...
var routes = [
    ...
    { path: 'calendrier', loadChildren: function () { return Promise.all(/*! import() | calendrier-home-module */[__webpack_require__.e("default~calendrier-home-module~menu-home-module"), __webpack_require__.e("calendrier-home-module")]).then(__webpack_require__.bind(null, /*! ./calendrier/home.module */ "./src/app/calendrier/home.module.ts")).then(function (m) { return m.HomePageModule; }); } }
];
...
module.exports = __webpack_require__(/*! D:\Cours\PTrans\devdacticCalendar\src\main.ts */"./src/main.ts");
